        ...
        <section className="relative py-20 bg-gradient-to-b from-salon-pink/20 to-white">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-playfair font-bold text-salon-dark mb-6">
              About <span className="text-salon-purple">Glam</span>
              <span className="text-salon-light-purple">Van</span>
            </h1>
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Egypt's first premium beauty-on-wheels experience, where elegance
              meets convenience
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                To provide safe, elegant, and hassle-free beauty services
                tailored to modern women across Greater Cairo — delivered
                exclusively by{" "}
                <span className="text-salon-purple font-playfair italic">
                  female
                </span>{" "}
                beauticians in fully equipped mobile salon vans.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow-md transition-transform hover:scale-105">
                ...
                <h3 className="font-playfair font-semibold text-xl mb-3">
                  Salon at Your Doorstep
                </h3>
                <p className="text-gray-600">
                  Book easily via app or website for the ultimate convenience
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md transition-transform hover:scale-105">
                ...
                <p className="text-gray-600">
                  Specially designed for bridal & event glam experiences
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md transition-transform hover:scale-105">
                ...
                <h3 className="font-playfair font-semibold text-xl mb-3">
                  All-<span className="text-salon-purple">Female</span> Staff
                </h3>
                <p className="text-gray-600">
                  For your comfort, safety, and complete privacy
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md transition-transform hover:scale-105">
                ...
                <p className="text-gray-600">
                  All vans and tools are sanitized after each client
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md transition-transform hover:scale-105">
                ...
                <p className="text-gray-600">
                  Cash, Vodafone Cash, InstaPay, and Cards accepted
                </p>
              </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Every member of our team is a licensed female professional,
                carefully selected for her skill, kindness, and ability to make
                you feel your absolute best — wherever you are.
              </p>
            </div>
          </div>
        </section>
