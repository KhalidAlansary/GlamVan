          ...
          <div className="space-y-8">
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li>
                  Payment Info: Method (e.g. Vodafone Cash, Visa), never full
                  card numbers.
                </li>
                <li>
                  Location Access: Used only with your permission for GPS
                  tracking of our van during service delivery.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li>To offer location-based van tracking</li>
                <li>To send service reminders and promos (if opted in)</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>Authorized team members (stylists/admin) only</li>
                <li>
