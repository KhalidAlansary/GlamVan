    ...
    <div className="space-y-6">
      <div className="flex flex-col items-center justify-center text-center mb-6">
        ...
        <p className="text-gray-600 mt-2">
          ...
          confirmation to your email and phone.
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="pt-3 border-t border-dashed border-gray-300">
            <div className="flex justify-between">
              ...
              <p className="font-bold text-salon-purple">
      ...
      <div className="bg-gray-50 p-4 rounded-md text-sm space-y-4">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">
            Please contact us at least 24 hours before your appointment to
            reschedule without any charges.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">
            Contact our customer support at support@glamvan.com or call us at
            +20 01123456789
          </p>
        </div>
      </div>
      ...
      <div className="text-center pt-4">
        <p className="text-sm text-gray-500">
          Thank you for choosing GlamVan Mobile Salon! We look forward to
          serving you.
        </p>
      </div>
    </div>
