          ...
          <div className="lg:w-1/2 mb-10 lg:mb-0 lg:pr-10">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Reserve our luxury van for the entire day (6AM-6PM) exclusively for your bridal party.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium text-salon-dark">Henna Night Services</h4>
                  <p className="text-gray-600 text-sm">
                    Traditional and modern henna designs for your pre-wedding celebration.
                  </p>
                </div>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-lg shadow-lg max-w-xs">
                ...
                <p className="text-gray-700 italic text-sm">
                  "A+ Ladies made my wedding day perfect! Their mobile salon was the perfect solution for me and my bridesmaids. Highly recommended!"
                </p>
              </div>
            </div>
          </div>
