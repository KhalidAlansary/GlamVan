  ...
  const steps = [
    {
      ...
      description:
        "Browse our range of services and select the ones that meet your beauty needs.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Choose a convenient date, time and location within our service areas.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Complete your booking with a secure payment through our multiple payment options.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      ...
      description:
        "On the day of your appointment, track our van in real-time as it approaches your location.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            ...
            mobile salon appointment in just a few steps.
          </p>
        </div>
