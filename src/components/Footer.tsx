        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-600 hover:text-salon-purple transition-colors">Home</Link></li>
          ...
          <div>
            ...
            <Link to="/contact" className="text-salon-purple hover:text-salon-dark-purple transition-colors">
              Book a Consultation
            </Link>
          </div>
        </div>
